      ...
      <div className={styles.pageContainer}>
        ...
        <div className={`dz-home__content ${styles.contentContainer}`}>
          <div className={styles.statementsContainer}>
            <h2>
              Who the heck is 👨‍💻{" "}
              <em style={{ whiteSpace: "nowrap" }}>Daniel Zotti</em>?!
            </h2>
            ...
            <StatementWithIcon
              ...
              showIcon={false}
            >
              I type letters and numbers on my keyboard developing web apps with{" "}
              ...
              . I love <strong>RxJs</strong> and functional programming, and
              I&apos;m really curious about the latest{" "}
            ...
            >
              ...
              gives me money 💰 to do the stuff I wrote above.
            </StatementWithIcon>
