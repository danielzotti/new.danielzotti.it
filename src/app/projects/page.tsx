  ...
  return (
    <InternalPageLayout>
      ...
      <div className={styles.projects}>
        ...
        <Teaser title={'Slide Roulette'}
          description={'An app to test your improvising skills going through a random presentation!'}
        ...
        <Teaser title={'Fake 3D Website'}
          description={'A fake 3D simulation using webcam or mouse move + mouse wheel'}
