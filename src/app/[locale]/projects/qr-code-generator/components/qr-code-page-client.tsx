...
export default function QrCodePage() {
  ...
  const downloadPng = useCallback(() => {
    ...
    const drawLogoAndDownload = () => {
      ...
      logoImg.onerror = () => {
         setErrorMessage(t("pngLogoError"));
        triggerDownload(canvas);
      };
      logoImg.src = logoSrc;
    };
    ...
    svgImg.onerror = () => {
       setErrorMessage(t("pngGenerationError"));
    };
    svgImg.src = svgDataUrl;
   }, [svg, showLogo, customLogoSrc, t]);
          ...
          <div className={styles.logoOptions}>
            ...
            {showLogo && (
              <div className={styles.logoUpload}>
                ...
                >
                   {customLogoSrc ? t("changeLogo") : t("uploadLogo")}
                </Button>
                {customLogoSrc && (
                  <Button
                    variant="secondary"
          ...
          <div>
            ...
            <div className={styles.downloadButtons}>
              <Button variant="outline" onClick={downloadSvg}>
                <FontAwesomeIcon icon={faDownload} /> {t("downloadSvg")}
              </Button>
              <Button variant="outline" onClick={downloadPng}>
                <FontAwesomeIcon icon={faDownload} /> {t("downloadPng")}
              </Button>
            </div>
          </div>
        )}
