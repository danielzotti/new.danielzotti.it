...
export const danielzottiTimeline = [
  {
    year: 1987,
    event:
      "Daniel is born in Trieste, Italy on the 16th of April and the world has changed forever! ...or it remained the same, I don't remember correctly...",
    categories: ["life"],
  },
  {
    year: 1991,
  ...
  },
  {
    year: 2007,
    event:
      "First university trainee in the IT department at Burlo Garofolo in Trieste",
    categories: ["work"],
  },
  {
    year: 2008,
    event:
      "First job as a developer in the IT department at Burlo Garofolo in Trieste",
    categories: ["work"],
  },
  {
    year: 2014,
...
export const danielzottiInfo = {
  about: () => {
    console.log(
      "Daniel Zotti is born in Trieste on the 16th of April 1987. He is creative and loves joking around and having a good laugh!",
    );
  },
  career: (year?: number) => {
    consoleCool("My story as a creative web developer");
    const career = danielzottiTimeline
      .filter((el) => el.categories.includes("work"))
  ...
  invert: () => {
    ...
    consoleCool(
      "Congratulations, I have found a hidden method! You're an hacker, aren't you? 🤪",
