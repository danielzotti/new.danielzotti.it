...
export const activate90s = () => {
  alert(
    "YOU DID IT! You went back in time! You are now in the 90's and websites looked like this one........",
  );
...
export const is90sActive = () => {
  return (
    localStorage.getItem(config.themeLocalStorageName) === localStorage90sTheme
  );
};
